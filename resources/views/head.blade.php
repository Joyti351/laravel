<head>
        ...
        <link rel="apple-touch-icon" href="cssfile/images/favicon.png">
        <link rel="shortcut icon" href="cssfile/images/favicon.png" type="image/x-icon">
        <!-- fonts file -->
        <link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        <!-- css file  -->
        <link rel="stylesheet" href="cssfile/css/plugins.css">
        <link rel="stylesheet" href="cssfile/css/bootstrap.min.css">
        <link rel="stylesheet" href="cssfile/css/flaticon.css">
        <link rel="stylesheet" href="cssfile/css/style.css">
        <link rel="stylesheet" href="cssfile/css/responsive.css">
        <script src="cssfile/js/modernizr-3.11.2.min.js"></script>
    </head>